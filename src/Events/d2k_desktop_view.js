...
export default function D2k_desktop_view() {
  ...
  return (
    <div className="body w-screen h-screen flex align-items-center  justify-start ">
      <Particles
        options={options}
        init={particlesInit}
        style={{
      ...
      <div className="w-full h-full flex align-items-center justify-start">
        <img
          src={deathstar}
          alt="image"
          className="w-[400px] h-[400px] object-cover mt-[15vh] ml-[-200px] z-2"
        ></img>
        <div className="container mt-[30vh] ml-[25px]">
